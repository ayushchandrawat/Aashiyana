...
function buildDriveSetupHint() {
  ...
  link.href =
    "https://github.com/AyushChandrawat/Aashiyana/blob/main/docs/installation.md#google-drive-document-storage-optional";
  link.target = "_blank";
...
function buildGoogleDriveProvider(data, reload) {
  ...
  provider.appendChild(
    createInfoList([
      ...
      { label: t("settings.documentStorageGoogleDriveFolder"), value: drive.folder_name || "Aashiyana/Documents" },
