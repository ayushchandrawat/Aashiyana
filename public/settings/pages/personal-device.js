  ...
  button.addEventListener('click', async () => {
    ...
    try {
      ...
      if (result.outcome === 'accepted') {
        window.aashiyana?.showToast(t('settings.pwaInstallAcceptedToast'), 'success');
      } else if (result.outcome === 'ios') {
        window.aashiyana?.showToast(t('settings.pwaInstallIosToast'), 'default');
      } else if (result.outcome === 'installed') {
        window.aashiyana?.showToast(t('settings.pwaInstallAlreadyInstalledToast'), 'default');
      } else if (result.outcome === 'unavailable') {
        window.aashiyana?.showToast(t('settings.pwaInstallUnavailableToast'), 'warning');
      }
    } catch (error) {
