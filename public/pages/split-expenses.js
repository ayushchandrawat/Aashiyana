    ...
    content: `
      <form id="split-expense-form" class="split-form">
        ...
        <div class="split-form-row">
          ...
          <label>${t('splitExpenses.date')}<aashiyana-datepicker name="expense_date" type="date" value="${esc(expense?.expense_date || today)}"></aashiyana-datepicker></label>
        </div>
