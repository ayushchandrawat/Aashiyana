...
class AashiyanaDatepicker extends HTMLElement {
...
if (!customElements.get('aashiyana-datepicker')) {
  customElements.define('aashiyana-datepicker', AashiyanaDatepicker);
}

export { AashiyanaDatepicker };
