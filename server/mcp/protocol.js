...
const SERVER_INFO = { name: 'aashiyana', version: pkg.version };
 ...
 *           moduleAccess?: object|null, splitGuest?: boolean }} actor 
 * @param {any}    body      
 * @param {(err: Error) => void} [onInternalError] 
 * @param {{ requestHeaders?: object }} [requestContext] 
