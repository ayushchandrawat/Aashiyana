        ...
        CalendarDateOrDateTime: {
          ...
          oneOf: [
            ...
            },
            {
              ...
              description: 'Aashiyana local wall-clock value. Seconds and fractional seconds are optional and are normalized to YYYY-MM-DDTHH:MM.',
            },
            {
              type: 'string',
          ...
          properties: {
            ...
            i18n: {
              ...
              properties: {
                ...
                coreLocales: { type: 'array', items: { type: 'string' }, description: 'All locales supported by Aashiyana core.' },
              },
            },
