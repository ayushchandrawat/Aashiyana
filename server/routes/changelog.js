...
const RELEASES_URL = ''; // Optional: set to your own GitHub Releases API endpoint.
...
const REQUEST_HEADERS = {
  ...
  'User-Agent': 'Aashiyana/1.0 (+https://github.com/AyushChandrawat/Aashiyana)',
  ...
  router.get('/', async (_req, res) => {
    ...
    try {
      if (!RELEASES_URL) {
        ...
        throw new Error('No remote releases endpoint configured and no local changelog is available.');
      }
