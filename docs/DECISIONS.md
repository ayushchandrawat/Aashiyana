...
[SCOPE.md](SCOPE.md) says what Aashiyana will not become. This page is for the other kind of
answer: something Aashiyana does build, where the *shape* was argued out once in a thread and
...
Aashiyana is a household planner, not a company tool. The admin is usually a parent, and the
...
who somebody is, not what they may do, and Aashiyana had already replaced that inference with
...
relationship (#1007). Aashiyana had already answered it twice in the code before anybody asked:
