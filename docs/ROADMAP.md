...
[discussion](https://github.com/AyushChandrawat/Aashiyana/discussions/new?category=ideas); what Aashiyana will
...
- **Decided.** Aashiyana stays the server and a bridge is a client ([SCOPE.md section
...
- **Open.** The blocks-per-cycle-day change itself, in #1022; the side-by-side view of
  several members' timetables, decided in
