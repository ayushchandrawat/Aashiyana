...
`ix-dev/community/aashiyana/` in [`truenas/apps`](https://github.com/truenas/apps).
...
`ix-dev/community/aashiyana/`; die CI baut daraus den Train-Eintrag.
...
## Namensraum: `aashiyana`, nicht `oikos`
...
- `community/aashiyana` - der aktive Eintrag

Entsprechend heißen dort der Fragen-Block `aashiyana:`, die Konstante
`consts.aashiyana_container_name` und die Medien-URLs `apps/aashiyana/...`. Das ist
...
[truenas/apps#5494](https://github.com/truenas/apps/pull/5494) („aashiyana: update to
