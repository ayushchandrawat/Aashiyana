/**
 * Demo Seed Script - Aashiyana
 * Fills the database with realistic demo content for screenshots/mockups,
 * in English or German.
 * Usage: node scripts/seed-demo.js [--db /path/to/aashiyana.db] [--locale en|de]
 *
...
const DB_PATH = dbIdx !== -1 ? args[dbIdx + 1] : resolve(__dirname, '..', 'aashiyana.db');
